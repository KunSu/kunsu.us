<?php
    ...
    set_cookies("Laioffer");
    add_product_view_count("Laioffer");
?>
<!DOCTYPE html>
         ...
         <div class="entry tab-whole nine columns centered">
            ...
            <header class="entry-header">
               ...
               <div class="entry-meta">
                  <ul>
                     <li>May 2018 - June 2019</li>
                     <span class="meta-sep">•</span>								
                     <li>
                        <a rel="skills tag" title="" href="#">Laioffer</a>, 
                        <a rel="skills tag" title="" href="#">Santa Clara, CA</a>
                     </li>
                  </ul>
               </div> 
            ...
            <div class="experiences">
               <!-- <p class="lead"> -->
               <ul>
                  <li>Pioneered the development of cloud-based education learning platforms and involved in all stages of implementation from the first design and proof of concept to the final stage in production</li>
                  <li>Designed, developed, and deployed over 50 APIs into production using <b>​Golang</b>, <b>Python</b>.​ Result in an over 480% increase in user growth, and over 140% increase for daily active users within ten months</li>
                  <li>Setup ​<b>AWS API Gateway​</b> to create a unified API layer and created multiple pipelines to support various environments with <b>​AWS​ ​LB</b>,​ <b>​RDS​</b>, etc. Reduced deployment duration from an hour to 8 mins</li>
                  <li>Supervised and guided juniors and interns to perform their job responsibilities independently. Reduced the on-boarding time from one week to one day and increased team delivery efficiency by 10%-20%</li>
               </ul>
