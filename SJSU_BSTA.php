<?php
    ...
    set_cookies("SJSU_BSTA");
    add_product_view_count("SJSU_BSTA");
?>
<!DOCTYPE html>
         ...
         <div class="entry tab-whole nine columns centered">
            ...
            <header class="entry-header">
               ...
               <div class="entry-meta">
                  <ul>
                     <li>Oct 2016 – Dec 2017</li>
                     <span class="meta-sep">•</span>								
                     <li>
                        <a rel="skills tag" title="" href="#">San Jose State University​</a>, 
            ...
            <div class="experiences">
               <!-- <p class="lead"> -->
               <ul>
                    <li>Constructed and launched SJSU official websites using ​PHP​, ​HTML​, ​CSS​/​SCSS​, ​MySQL​.</li>
                    <li>Developed and integrated a user-friendly drawing tool into Drupal for thousands of students to create
                    interactive models of chemical reaction at the molecular level using ​PHP</li>
                    <li>Mentored master students to applied ML model to an actual web application using ​Python</li>
                    <li>Performed ​data preparation​ and d​ ata normalization​ on 40GB of real-world data using ​Regex</li>
               </ul>
