<?php
    ...
    set_cookies("Netherfire_Entertainment");
    add_product_view_count("Netherfire_Entertainment");
?>
<!DOCTYPE html>
         ...
         <div class="entry tab-whole nine columns centered">
            ...
            <header class="entry-header">
               ...
               <div class="entry-meta">
                  <ul>
                     <li>Dec 2014 - May 2015</li>
                     <span class="meta-sep">•</span>								
                     <li>
                        <a rel="skills tag" title="" href="#">Netherfire Entertainment</a>
                        <a rel="skills tag" title="" href="#">Sunnyvale, CA</a>
                     </li>
                  </ul>
               </div> 
            ...
            <div class="experiences">
               <!-- <p class="lead"> -->
               <ul>
                    <li>Responsible for functional testing new builds using SpiraTest.</li>
                    <li>Integrated frameworks for tracking and payment using PHP, MySQL and
                    HTML.</li>
               </ul>
