         ...
         <div class="entry tab-whole nine columns centered">
            ...
            <header class="entry-header">
               ...
               <div class="entry-meta">
                  <ul>
                     <li>Jan 2016 - May 2016</li>
                     <span class="meta-sep">•</span>								
                     <li>
                        <a rel="skills tag" title="" href="#">IBM</a>, 
            ...
            <div class="experiences">
               <!-- <p class="lead"> -->
               <ul>
                    <li>Participated in a machine learning system called Guiding Dog with IBM
                    Bluemix team to generate solutions for guiding dogs in non-profit organizations</li>
                    <li>Performed data preparation and data normalization on 40GB of real-world
                    data using Regex</li>
                    <li>Designed open source for distributed servers: Kafka, Cassandra, Hadoop
                    with Apache using Python</li>
                    <li>Sped up MapReduce jobs by 120% and decreased cost by 75% via a preprocessing method</li>
               </ul>
