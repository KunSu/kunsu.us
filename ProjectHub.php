<?php
    ...
    set_cookies("ProjectHub");
    add_product_view_count("ProjectHub");
?>
<!DOCTYPE html>
         ...
         <div class="entry tab-whole nine columns centered">
            ...
            <header class="entry-header">
               ...
               <div class="entry-meta">
                  <ul>
                     <li>May 2016 - April 2018</li>
                     <span class="meta-sep">•</span>								
                     <li>
                        <a rel="skills tag" title="" href="#">Project Hub Inc.</a>, 
                        <a rel="skills tag" title="" href="#">​San Jose, CA</a>
                     </li>
                  </ul>
               </div> 
            ...
            <div class="experiences">
               <!-- <p class="lead"> -->
               <ul>
                    <li>Led cross-functional teams of 5 to build 8+ websites from concept to post-launch in North America</li>
                    <li>Developed server-side ​RESTful ​web services and improved workflow efficiency by 40-50% through data
                    analytics features using ​Java​ a​ nd ​JSON</li>
                    <li>Designed and developed responsive web page in ​PHP​/​JavaScript​, ​HTML​, ​CSS​ on top of popularly
                    open-source third-party platforms such as WordPress, Drupal, and ​AngularJS</li>
                    <li>Managed product scope, task prioritization, and resource allocation based on ​Agile development</li>
                    <li>Set up dynamic website using ​Maven, Tomcat, Git, Jenkins, Junit, Docker and AWS services</li>
               </ul>
